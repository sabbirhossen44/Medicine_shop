        ...
        <nav class="sidebar">
            ...
            <div class="sidebar-body">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="#Admin" role="button" aria-expanded="false"
                            aria-controls="admin">
                ...
                <div class="navbar-content">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown nav-profile">
                            @php
                                $user = Auth::user();
                                $photo_path = public_path('uploads/users/', $user->photo);
                            @endphp
                            <a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                @if ($user->photo && file_exists($photo_path))
                                    <img src="{{ asset('uploads/admin/' . $user->photo)}}" alt="profile">
                                @else
